...
const ChapterFour: React.FC = () => {
  return (
    <section className="bg-white py-0 px-8 lg:px-12">
      ...
      >
        <h2 className="text-[#1F2937] font-sora font-bold text-xl md:text-2xl lg:text-3xl text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-4 lg:gap-y-6">
          {scenarios.map((item, index) => (
            <motion.div 
              ...
              className="group"
            >
              <div className="relative overflow-hidden rounded-[1.5rem] mb-2 aspect-[2/1] bg-gray-50 shadow-sm border border-gray-100">
                <img 
                  src={item.image} 
                  alt={item.title} 
              ...
              <h3 className="text-[#1F2937] font-sora font-bold text-base mb-1 leading-tight">
                {item.title}
              </h3>
